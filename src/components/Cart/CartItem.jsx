          ...
          <div className="col-4">
            ...
            <div className="col-8">
                ...
                <div className="row">
                    ...
                    <input type="text" className="text-center" style={{border:"none", width:"25px"}} value={item.quantity} readOnly/>
                    <span className="input-group-btn">
                          <button type="button" className="btn btn-default">
                    ...
                    <div className="col d-flex align-items-center justify-content-start">
                        <input type="text" style= {{border:"none", width:"100px", fontWeight:"bold", textAlign:"right"}} value={"$" + item.product.price * item.quantity} readOnly/>
                    </div>
                </div>
            </div>
        </div>
